...
| 4. 包实现上下文 | [`docs/40-implementation/packages/bff/40-console.md`](../../docs/40-implementation/packages/bff/40-console.md) |

> 职责：租户 console BFF（RP 会话、订阅下单、subscribe-context）
