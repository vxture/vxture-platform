...
| 4. 包实现上下文 | [`docs/40-implementation/packages/agents/agent-template/20-studio.md`](../../docs/40-implementation/packages/agents/agent-template/20-studio.md) |

> 职责：agent studio 前端模板（新 agent 前端脚手架）
