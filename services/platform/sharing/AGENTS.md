...
| 4. 包实现上下文 | [`docs/40-implementation/packages/services/95-sharing.md`](../../../docs/40-implementation/packages/services/95-sharing.md) |

> 职责：SharingGrant 共享授权域
