...
| 4. 包实现上下文 | [`docs/40-implementation/packages/services/subscription.md`](../../../docs/40-implementation/packages/services/70-subscription.md) |

> 订阅与功能门控：hasFeature() 是核心 API。
