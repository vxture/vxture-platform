...
| 4. 包实现上下文 | [`docs/40-implementation/packages/services/90-provisioning.md`](../../../docs/40-implementation/packages/services/90-provisioning.md) |

> 职责：订阅开通/provisioning
