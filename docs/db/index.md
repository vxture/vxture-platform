...
见 [`docs/deployment/08-code-environment-map.md`](../deployment/08-code-environment-map.md) — 明确本仓与外部业务仓库的数据库和部署边界。
...
| 文档                                                                                             | 内容                                         |
| ------------------------------------------------------------------------------------------------ | -------------------------------------------- |
| [`../design/data_platform_100_architecture.md §14`](../design/data_platform_100_architecture.md) | `admin.governance_record` 统一治理视图表设计 |
| [`../design/data_platform_100_architecture.md §15`](../design/data_platform_100_architecture.md) | `support.ticket` 工单表 + 运营待办聚合方案   |
