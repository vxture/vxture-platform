...
相关文档：[`00-overview.md`](00-overview.md) · [`04-services.md`](04-services.md) · [`08-code-environment-map.md`](08-code-environment-map.md) · [`../ai/port-allocation.md`](../ai/port-allocation.md)
...
遵循 playbook（`docs/standards/container-healthcheck-standard.md`）纪律：一项一 PR、改 compose 后经晋升+部署验证、`docker inspect .State.Health` 实测。
