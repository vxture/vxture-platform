...
| runos(L1)       | 待分配                         | **3120 / 3121**(预留)                                                                                                                                                                                            | runos.ai / 待分配                                      | 待分配                                                         | `runos-*`                   | `vxturebiz_runos_{env}` + `runos_svc`                     | 入 tailnet                                     | 未部署(env 已预留)                                                                                    |
...
1. **域名**:`{code}.vxture.com` 缺省规则(product_100 §2 已有异 apex 例外:runos.ai/anlan.ai/xuanzhen.ai);beta = `beta-{code}.vxture.com`(arda 先例)。
