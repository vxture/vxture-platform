...
| ontos(L1)       | 待分配                         | **3110 / 3111**(预留)                                                                                                                                                                                            | ontos.vxture.com / 待分配                              | 待分配                                                         | `ontos-*`                   | `vxturebiz_ontos_{env}` + `ontos_svc`                          | 入 tailnet(类 2)                               | **在产**(v0.1.0 首次生产部署端到端成功,2026-08-09;beta 3121 预留但休眠,见 runos TD-006)               |
