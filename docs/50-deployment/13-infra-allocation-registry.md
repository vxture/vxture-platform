...
| atlas(L1)       | worker-02                      | **3100 / 3101**(现状 3100 单口无beta,新方案预留 3101 供未来 beta)                                                                                                                                                | atlas.vxture.com / 待分配                              | 待分配(建议 `/srv/md0/atlas`,随 arda 惯例;未经 owner 逐格确认) | `atlas-*`                   | `vxturebiz_atlas_{env}` + `atlas_svc`                          | 入 tailnet(类 2,`<worker-02-tailnet-ip>:3100`) | **在产**(独立仓 `vxture-atlas` 已部署 worker-02:3100,2026-07-27 口头确认;stack_root/域名接入状态待补)                                                           |
| ontos(L1)       | 待分配                         | **3110 / 3111**(预留)                                                                                                                                                                                            | ontos.vxture.com / 待分配                              | 待分配                                                         | `ontos-*`                   | `vxturebiz_ontos_{env}` + `ontos_svc`                          | 入 tailnet(类 2)                               | **未建仓/未设计构建**(2026-08-10 核实:`vxture-ontos` 仓 size=0、只有一个 `Initial commit`、无任何 workflow、无分支保护;端口/域名/库名均为**预留**,不代表已部署) |
