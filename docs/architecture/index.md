...
> Shared / Model Runtime Client / Design System / Platform SDK 的实现约束见 [`docs/packages/`](../packages/index.md)
...
见 [`docs/design/index.md`](../design/index.md) — 跨包能力域端到端设计（Model Platform、控制面、auth、tenant 等）。
...
- 删除与 `docs/packages/` 完全重复的层级文档：Shared、Model Runtime Client、Design System、Platform SDK 专项文档
- 迁移定位错误的文件：12-typescript → `docs/ai/04-coding-typescript.md`；14-model-platform → `docs/design/`；15-control-plane-overview → `docs/design/`
