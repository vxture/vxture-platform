...
- C2/C3 端点形状 = ADR-11 §11.7 + [`docs/product/arda/arda_200_interface.md`](../../product/arda/arda_200_interface.md)；
- 三通道标准 = [`docs/design/product_200_integration.md`](../../design/product_200_integration.md)；
- 契约收缩（信封 v2）产品侧最终要求 = [`docs/product/arda/arda_300_integration-final.md`](../../product/arda/arda_300_integration-final.md) §1。
