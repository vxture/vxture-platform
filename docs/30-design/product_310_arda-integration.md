...
> **与 [`arda_300`](../20-specs/arda/arda_300_integration-final.md) 的分工**（去重，勿两处重述）：本文（design 侧）= 平台怎么交付 + 决策**概要索引**（结论 + 指针）；`arda_300`（产品包侧，线 B 面向）= 产品侧义务 + 决策**详细留痕**（结论 + 否决方案 + 依据）。**决策的"为什么/否决什么"以 arda_300 §2 与 product_220 §7 为准，本文不重述。**
...
> 产品侧落地包：[`arda_000`](../20-specs/arda/arda_000_definition.md)（定义）、[`arda_100`](../20-specs/arda/arda_100_handoff.md)（交接）、[`arda_200`](../20-specs/arda/arda_200_interface.md)（接口契约）、[`arda_300`](../20-specs/arda/arda_300_integration-final.md)（最终要求 + 决策详细留痕）。
...
> **本表只留结论 + 权威指针（概要）**。每条决策"为什么这样、否决了什么旧方案"的**详细防回退留痕**——产品面决策见 [`arda_300`](../20-specs/arda/arda_300_integration-final.md) §2，全平台契约级见 [`product_220`](./product_220_catalog-resource-model.md) §7「明确不采纳」/§10。改动前先读那两处。
...
| D3     | Arda v1 范围     | 不含 P 级资产供给                                                                      | [`arda_000`](../20-specs/arda/arda_000_definition.md) §3                |
