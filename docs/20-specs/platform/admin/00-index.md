...
> 技术实现：[`docs/40-implementation/packages/portals/admin.md`](../../../40-implementation/packages/portals/admin.md)
> BFF：[`docs/40-implementation/packages/bff/admin.md`](../../../40-implementation/packages/bff/admin.md)
...
| [`docs/30-design/auth.md § 钉钉配置参考`](../../../30-design/auth.md)                                          | 钉钉 OAuth 配置（仅用于 website-bff，admin 禁用）               |
