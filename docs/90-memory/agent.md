...
| 详细编码规则                              | `docs/40-implementation/ai/01-coding-rules.md`    |
| 注释格式                                  | `docs/40-implementation/ai/03-coding-comments.md` |
| 代码风格                                  | `docs/40-implementation/ai/02-coding-style.md`    |
