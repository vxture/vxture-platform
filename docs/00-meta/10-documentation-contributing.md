...
- Follow the writing style guidelines in `docs/40-implementation/ai/02-coding-style.md`
...
- Link to related concepts using relative file paths (e.g., `[Architecture Overview](../30-design/architecture/00-overview.md)`)
...
- `docs/30-design/architecture/00-overview.md`
- `docs/30-design/identity-platform-access-topology.md`
- `docs/50-deployment/02-infrastructure.md`
