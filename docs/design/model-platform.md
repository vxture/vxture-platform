...
P5 is still not a separate service split; it is production hardening implemented in `@vxture/service-model-platform` and `docs/deployment/11-model-platform-operations.md`.
