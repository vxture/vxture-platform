...
> 说明:"bundled 作为 tier 第六值"的旧消费规则已被 §3 的 `bundled` 布尔正交轴取代（防回退留痕见 [`arda_300`](../product/arda/arda_300_integration-final.md) §2）。
...
5. 其余(缓存/409/webhook/gauge)见 [`arda_200`](../product/arda/arda_200_interface.md) 契约,不变。
