...
> 族外:决策记录 = ADR-11/ADR-12(ADR 自有编号线);评审/过程留档([`sharing-isolation-review.md`](sharing-isolation-review.md))与 owner 原稿([`inputs/`](inputs/README.md))**不进编号体系**;各产品定义文档归 `docs/product/` 产品文档线。
