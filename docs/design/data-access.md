...
> 版本：1.0.0 | 2026-05-15
> 上级文档：[`docs/design/data_platform_100_architecture.md`](data_platform_100_architecture.md)（平台数据架构顶层权威；原 database.md 已并入）
...
dep-cruiser 规则（`docs/audit/rules/` 中维护）强制检查：
