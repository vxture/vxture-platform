...
> 对外使用规范：[`packages/design-system/docs/`](https://github.com/vxture/vxture-design/tree/main/packages/design-system/docs)（随包发布，2026-08-21 起在 `vxture/vxture-design`）；内部工程规范：[`docs/10-standards/060-design-system.md`](../../../10-standards/060-design-system.md)
