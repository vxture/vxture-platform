...
| 包                              | 路径               | 域名                 | 服务对象                              |
| ------------------------------- | ------------------ | -------------------- | ------------------------------------- |
| [`website.md`](./30-website.md) | `portals/website/` | `vxture.com`         | 公众（官网、注册、登录）              |
| [`console.md`](./20-console.md) | `portals/console/` | `console.vxture.com` | 租户管理员（工作台、成员、账单）      |
| [`admin.md`](./10-admin.md)     | `portals/admin/`   | `y.vxture.com`       | 平台运营者（租户管理、工单、AI 配置） |
