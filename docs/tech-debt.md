...
| **状态**     | Open                                             |
| **登记日期** | 2026-05-14                                       |
| **来源**     | `docs/design/model-platform.md` §11 后续推荐工作 |
...
| **状态**     | Open                                                                            |
| **登记日期** | 2026-05-14                                                                      |
| **来源**     | `docs/design/model-platform.md` §11 后续推荐工作；§5 `ai_model.api_key_env_var` |
...
| **状态**     | Open                                                                    |
| **登记日期** | 2026-05-14                                                              |
| **来源**     | `docs/design/model-platform.md` §10 Phase 1 Seed、§6 Cost And Fee Model |
...
| **登记日期** | 2026-07-04                                                                                                                                                                                                                                                                             |
| **解决日期** | 2026-07-05                                                                                                                                                                                                                                                                             |
| **来源**     | PR #609 安全评审（B9）；`docs/design/identity-platform-internal-delegation.md`；`bff/auth-bff/src/routers/operator-admin-internal.router.ts`（reset-password 回传 `resetLink`）；`bff/admin-bff/src/routers/platform-admins.router.ts`（`assertCanManagePlatformAdmins` 无 rank 门控） |
...
| **登记日期** | 2026-07-05                                                                                                                                 |
| **来源**     | `docs/product/platform/admin/admin-app-completion-plan.md`；`bff/admin-bff/src/routers/platform-admins.router.ts`（仅 openRiskCount 聚合） |
...
**进展**：2026-07-05 设计稿已成 → [`docs/product/platform/admin/governance-write-paths.md`](product/platform/admin/governance-write-paths.md)（三表工作流/状态机、端点清单、权限映射含新增 `tenant:risk.*`/`compliance:event.*` 四码、GQ1–GQ8 默认决策），owner 审定（v1.1，修订 4 处）后按 G1/G2/G3 实施。
